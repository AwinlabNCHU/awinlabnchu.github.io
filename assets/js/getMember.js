import { calculateMemberStats, animateCount } from "./members/statistics.js?v=2.1";
import { createMemberCard } from "./members/cardCreator.js?v=2.1";
import { renderPaginationButtons } from "./members/pagination.js?v=2.1";
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    const response = await fetch("assets/data/lab_members.json?v=2.1");
