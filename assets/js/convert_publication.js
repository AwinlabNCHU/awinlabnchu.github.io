import { createChartManager } from "./publications/chartManager.js?v=3.0.2-preview.1";
import { createPaginationControls } from "./publications/pagination.js?v=3.0.2-preview.1";
import { createDisplayManager } from "./publications/displayManager.js?v=3.0.2-preview.1";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updatePagination(totalItems) {
    createPaginationControls(totalItems, currentPage, (page) => {
      ...
      updatePagination(totalItems); // Re-render with new page
    }, ITEMS_PER_PAGE);
  }

  fetch("assets/data/journal_list.json?v=3.0.2-preview.1")
