import { createChartManager } from "./publications/chartManager.js?v=3.0.1";
import { createPaginationControls } from "./publications/pagination.js?v=3.0.1";
import { createDisplayManager } from "./publications/displayManager.js?v=3.0.1";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch("assets/data/journal_list.json?v=3.0.1")
